...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity)
        ...
        httpSecurity
                ...
                .permitAll()
                .and()
                .authorizeRequests().antMatchers("/news/addnews", "/news/deletenews", "/news/editnews", "/files/**").hasAnyRole("ADMIN", "STAFF")
                .and()
                .authorizeRequests().antMatchers("/contactus/fetchcontactus", "/files/**").hasAnyRole("ADMIN", "STAFF")
                .and()
